...
const MOCK_DEEPLINKS = Array.from({ length: 20 }, (_, i) => ({
  ...
  clicks: 10 + i * 7 + (i % 5), // number of users / times this deeplink was used
}));
    ...
    <div className="min-w-0 overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="flex flex-col gap-4 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-5">
        ...
        <div className="min-w-0 sm:max-w-xs">
          <input
            type="search"
            placeholder="Search by User ID, Email, Offer, or Deeplink..."
            value={searchQuery}
        ...
        <Table className="min-w-[720px]">
          <TableHeader className="border-gray-100 dark:border-gray-800">
            <TableRow>
              ...
              <TableCell isHeader className="py-3 text-center text-theme-xs font-medium text-gray-500 dark:text-gray-400">Offer Name</TableCell>
