...
export default function InternalMockBanner() {
  return (
    <div
      className="fixed left-0 right-0 top-0 z-[9999] pointer-events-none bg-amber-500 text-gray-900 text-center py-1.5 text-xs font-bold tracking-wider uppercase"
      role="status"
