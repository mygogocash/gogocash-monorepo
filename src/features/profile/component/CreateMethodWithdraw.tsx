...
const EMPTY_FORM: RequestCreateMethodWithdraw = {
  account_no: "",
  account_name: "",
  bank_name: "",
  bank_code: "",
...
function methodToForm(d: DataMethodWithdraw): RequestCreateMethodWithdraw {
  return {
...
function CreateMethodWithdrawForm({ methodId, initialForm }: FormProps) {
      ...
      <div className="flex w-full max-w-[720px] flex-col gap-6">
        ...
        {methodTab === "promptpay" ? (
          <>
            ...
            <div className="flex w-full flex-wrap items-start justify-end gap-6">
              <button
                type="button"
                disabled={busy}
                onClick={() => router.push("/method")}
                className="flex h-[52px] w-[200px] max-h-[52px] shrink-0 cursor-pointer items-center justify-center rounded-full border border-solid border-[#00CC99] bg-white px-6 py-3 text-base font-medium text-[#00CC99] transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
              >
              ...
              <button
                ...
                className={`flex h-[52px] w-[200px] max-h-[52px] shrink-0 cursor-pointer items-center justify-center rounded-full px-6 py-3 text-base font-medium transition-opacity ${
