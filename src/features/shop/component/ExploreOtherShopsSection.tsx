...
export type ExploreOtherShopsSectionProps = {
  offers: DataOffer[];
  lg: boolean;
...
/**
 * Shared “Explore other Shops” section: border-top band, heading + View all, list impression tracker, 2×2 / 4-col grid with Grab Coupon cards.
 */
export default function ExploreOtherShopsSection({
  offers,
  lg,
  getFavouriteOffer,
  loadingFav,
