      ...
      <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03] lg:p-8">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none space-y-10">
          ...
          <section>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Manage offers that users can complete for rewards. Create or edit offers, set logos and links, and control visibility. Offer details can be linked to quest tasks and coupons.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Manage banners shown on the app homepage. Upload, reorder, or update banner images and links. You can also configure app-open popup settings from the banner area.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-inside list-disc space-y-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <li>
                <strong>Coupon History</strong> — View past coupons and redemption history for reporting.
              </li>
            </ul>
          </section>
          ...
          <section>
            <h2 className="mb-3 text-lg font-semibold text-gray-800 dark:text-white">
              12. Deeplink Management
            </h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Manage deeplinks used to open specific screens or offers in the app. Create and maintain links for campaigns, notifications, or in-app navigation.
            </p>
          </section>
