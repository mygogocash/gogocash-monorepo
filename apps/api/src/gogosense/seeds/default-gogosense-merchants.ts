...
export const defaultGogosenseMerchants: GogosenseMerchantSeed[] = [
  ...
  candidate('traveloka', 'Traveloka', ['com.traveloka.android'], ['traveloka.com']),
  ...
  candidate('line-man', 'LINE MAN', ['com.linecorp.linemanth'], ['lineman.line.me']),
  candidate('foodpanda', 'foodpanda', ['com.global.foodpanda.android'], ['foodpanda.co.th']),
  ...
  candidate('amazon', 'Amazon', ['com.amazon.mShop.android.shopping'], ['amazon.com']),
  candidate('aliexpress', 'AliExpress', ['com.alibaba.aliexpresshd'], ['aliexpress.com']),
