...
const GOGOPASS: PremiumStyle = {
  ...
  ringGradient: "conic-gradient(from 0deg, #F4E4A8, #D4AF37, #B8860B, #F4E4A8, #D4AF37)",
  label: "GoGoPass",
};
...
const GOGOPASS_PRO: PremiumStyle = {
  ...
  accentSoft: "#FFE680",
  onAccent: "#1A1400",
  ringGradient: "conic-gradient(from 0deg, #FFE680, #C9A227, #8B6914, #FFE680, #C9A227)",
  label: "GoGoPass Pro",
};
...
export function premiumStyleFor(tier: MembershipTier | undefined): PremiumStyle | null {
