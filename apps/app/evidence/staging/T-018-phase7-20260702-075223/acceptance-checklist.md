...
- [x] GoGoTrack activation nudge visible: pass - ./evidence/staging/T-018-phase7-20260702-075223//gototrack-hub-ui.xml contains activation nudge evidence
- [x] GoGoTrack activation nudge tapped: pass - ./evidence/staging/T-018-phase7-20260702-075223//gototrack-hub-ui.xml tapped at 600,1031
- [x] Authenticated API reachable: pass - GET /gototrack/settings accepted token
- [ ] Detection probe matched: missing
- [ ] Activation deeplink returned: fail - requires --detect-package before activation
