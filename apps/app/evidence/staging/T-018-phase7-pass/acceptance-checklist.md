...
Activation deeplink foreground package: com.shopee.th
Activation deeplink: https://invl.me/clnlpe6
...
- [x] GoGoTrack activation nudge visible: pass - ./evidence/staging/T-018-phase7-pass//gototrack-hub-ui.xml contains activation nudge evidence
- [x] GoGoTrack activation nudge tapped: pass - ./evidence/staging/T-018-phase7-pass//gototrack-hub-ui.xml tapped at 600,1031
- [x] Authenticated API reachable: pass - GET /gototrack/settings accepted token
- [x] Detection probe matched: pass - matched Shopee
- [x] Activation deeplink returned: pass - https://invl.me/clnlpe6
- [x] Activation deeplink opened: pass - https://invl.me/clnlpe6
- [x] Activation deeplink post-open foreground captured: pass - com.shopee.th after activation deeplink
