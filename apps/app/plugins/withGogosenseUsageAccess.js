...
function applyGogosenseUsageAccessManifest(manifest) {
  if (!manifest.$) {
    manifest.$ = {};
  }
...
function withGogosenseUsageAccess(config) {
  return withAndroidManifest(config, (cfg) => {
    applyGogosenseUsageAccessManifest(cfg.modResults.manifest);
    return cfg;
  });
}

module.exports = withGogosenseUsageAccess;
module.exports.applyGogosenseUsageAccessManifest = applyGogosenseUsageAccessManifest;
