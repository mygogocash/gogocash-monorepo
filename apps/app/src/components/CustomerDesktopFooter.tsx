...
export function CustomerDesktopFooter({
  ...
  return (
    <View
      accessibilityLabel="GoGoCash footer"
      style={[
        styles.footerOuter,
        {
      ...
      <View style={[styles.footerContent, { width: contentWidth }]}>
        ...
        <View style={styles.footerBottom}>
          ...
          <View style={styles.socialRow}>
            {webDesktopFooter.socialLinks.map((social) => (
              <Link
                asChild
...
function FooterCloudflareTrust() {
  ...
  return (
    <View style={styles.cloudflareBlock}>
      ...
      <Link
        asChild
        href={webDesktopFooter.cloudflare.href as never}
        rel="noopener noreferrer"
        target="_blank"
      >
        <MotionPressable
        ...
        >
          <Image
            ...
            resizeMode="contain"
            source={cloudflareLogoImage}
            style={styles.cloudflareLogo}
          />
        </MotionPressable>
      </Link>
    </View>
...
const footerSocialIconPaths: Record<FooterSocialIconName, string> = {
